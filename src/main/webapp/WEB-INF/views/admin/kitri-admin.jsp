	...
	<div id="hd">
		...
		<div id="wrapper">
			...
			<div id="Mcontent">
				<div class="room_info">
					<div class="r_Title">
						스테이키트리 <strong>객실안내</strong><br />
						<span>STAYAN ROOM'S INFOMATION</span>
					</div>
					<a href="/rooms/kitri-doubleRoom"
						class="rn1">
						<p>
							2인실<br />(Twin bed)
						</p> <span></span>
					</a> <a href="/rooms/kitri-doubleRoomFloor"
						class="rn2">
						<p class="one">2인실 온돌</p> <span></span>
					</a> <a href="/rooms/kitri-tripleRoom"
						class="rn3">
						<p class="one">3인실</p> <span></span>
					</a> <a href="/rooms/kitri-quadRoom"
						class="rn4">
						<p>
							4인실<br />(Domitory)
						</p> <span></span>
					</a> <a href="/rooms/kitri-sextupleRoom"
						class="rn5">
						<p>
							6인실<br />(Domitory)
						</p> <span></span>
					</a> <a href="/rooms/kitri-facRoom"
						class="rn6">
				...
				<div class="cust">
					<dl>
						<dt>
							<a
								href="reserve/kitri-reserve">실시간
								<b>예약하기</b><span class="res_btn"></span>
							</a>
						</dt>
						<dd>
							예약 상담 및 문의<br /> <strong>010.9191.4465</strong><br /> <span>전주은행
								예금주 : 스테이키트리(최인환)</span><br />
